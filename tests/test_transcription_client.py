...
class TestTranscriptionClient:
    ...
    @patch('builtins.open', new_callable=mock_open, read_data=b'fake_audio_data')
    @patch('src.transcription_client.Mistral')
    def test_transcribe_audio_api_error(self, mock_mistral_class, mock_file, mock_exists):
    ...
    @patch('builtins.open', new_callable=mock_open, read_data=b'fake_audio_data')
    @patch('src.transcription_client.Mistral')
    def test_transcribe_with_timestamps(self, mock_mistral_class, mock_file, mock_exists):
