...
class TestPipeline:
    ...
    def test_process_video_success(self, mock_extract, mock_transcription_class, mock_generator_class, tmp_path):
    ...
    @patch('src.pipeline.TranscriptionClient')
    @patch('src.pipeline.extract_audio')
    def test_process_video_extraction_fails(self, mock_extract, mock_transcription_class, mock_generator_class, tmp_path):
    ...
    @patch('src.pipeline.TranscriptionClient')
    @patch('src.pipeline.extract_audio')
    def test_process_video_transcription_fails(self, mock_extract, mock_transcription_class, mock_generator_class, tmp_path):
    ...
    @patch('src.pipeline.TranscriptionClient')
    @patch('src.pipeline.extract_audio')
    def test_process_video_subtitle_generation_fails(self, mock_extract, mock_transcription_class, mock_generator_class, tmp_path):
    ...
    @patch('src.pipeline.TranscriptionClient')
    @patch('src.pipeline.extract_audio')
    def test_process_video_no_api_key(self, mock_extract, mock_transcription_class, mock_generator_class):
    ...
    @patch('src.pipeline.TranscriptionClient')
    @patch('src.pipeline.extract_audio')
    def test_process_video_with_progress_callback(self, mock_extract, mock_transcription_class, mock_generator_class, tmp_path):
        ...
        assert "transcrib" in calls[1].lower()  # Covers "transcribe", "transcription", etc.
