...
class TestIntegration:
    ...
    def test_pipeline_with_real_api(self, mistral_api_key, test_video_file, tmp_path):
        ...
        try:
            ...
            assert (
                "timestamp" in str(e).lower()
                or "extraction" in str(e).lower()
                or "transcription" in str(e).lower()
            )

    @pytest.mark.integration
    def test_transcription_client_real_api(
        self, mistral_api_key, test_video_file, tmp_path
    ):
